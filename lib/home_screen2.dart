...
void _scrollListener() {
  ...
  void _toggleBottomBarVisibility(TapDownDetails details) {
    final screenHeight = MediaQuery.of(context).size.height;
    final appBarHeight = screenHeight * 0.35; // Height of the SliverAppBar
    final tapPosition = details.localPosition.dy;

    setState(() {
      isBottomBarVisible = tapPosition >= appBarHeight;
    });
  }
          ...
          home: SafeArea(
            child: Scaffold(
              body: GestureDetector(
                onTapDown: _toggleBottomBarVisibility,
                  ...
                  SliverAppBar(
                    ...
                    title: ListTile(
                      contentPadding: EdgeInsets.only(
                          left: 6, right: 0, top: 5, bottom: 10),
                      trailing:
                          SvgPicture.asset('android/app/images/profile.svg'),
                      title: TextField(
                        style: TextStyle(
                      ...
                      child: Column(
                        children: [
                              ...
                              Positioned(
                                child: Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: Image(
                                      image:
                                          AssetImage("android/app/images/map.png"),
                          ...
                          Container(
                            ...
                            child: Card(
                              child: Image.asset(
                                'android/app/images/suggestion.png',
                                height: 150,
                              ), 
                            ),  
                          ),
                          ...
                          Container(
                            ...
                            child: Card(
                              child: Image.asset(
                                  'android/app/images/delivery.png',
                                height: 100,
              ...
              bottomNavigationBar: AnimatedContainer(
                ...
                height: isBottomBarVisible ? screenHeight * 0.12 : 0,
                width: screenWidth,
                decoration: BoxDecoration(
                ...
                child: ClipRRect(
                  ...
                  child: BottomNavigationBar(
                    ...
                    items: [
                      ...
                      BottomNavigationBarItem(
                        icon: Image.asset('android/app/images/ambulance.png',
                            width: 40),
                        label: 'Ambulance',
                      ),
                    ],
